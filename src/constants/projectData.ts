...
const projectData: Project[] = [
  ...
  },
  {
    ...
    demo: {
      ...
      notes: 'API: http://localhost:4000/health',
    },
  ...
  },
  {
    title: 'IceGuard AI',
    description:
      'Geospatial iceberg detection with map visualization and deterministic safety reports.',
  ...
  },
  {
    ...
    description:
      'RAG market insights — offline corpus or dynamic answers via the Ollama open-source LLM.',
  ...
  },
  {
    ...
    repoUrl:
      'https://github.com/bagherianahita/AI-Powered-Sales-Email-Personalization-Engine',
    demo: {
      kind: 'web',
  ...
  },
  {
    ...
    description:
      'ML urgency/topic classification with routing queues — browser demo plus FastAPI.',
  ...
  },
  {
    ...
    description:
      'Trust-scoring logic audits with scenario presets — browser demo plus a production TypeScript auditor API.',
    ...
    demo: {
      ...
      notes:
        'Production service: github.com/bagherianahita/Debugger-Auditor-Service — http://localhost:4000/health',
    },
  ...
  },
  {
    ...
    description:
      'FastAPI JWT auth with workouts and routines — browser login demo (demo / demo123).',
    ...
    demo: {
      ...
      run: 'pip install -r requirements.txt && uvicorn main:app --port 8002 --host 127.0.0.1',
      notes: 'Swagger: http://localhost:8002/docs',
    },
  ...
  },
  {
    ...
    description:
      'ETL pipeline for session datasets with rolling-average download trend charts.',
    technologies: ['Python', 'Pandas', 'Streamlit', 'Matplotlib'],
    repoUrl: 'https://github.com/bagherianahita/Conversion-Funnel-ETL',
    demo: {
      kind: 'web',
      localUrl: 'http://localhost:8508',
      run: 'pip install -r requirements.txt && streamlit run app.py',
      notes: 'CLI: python etl.py',
    },
  ...
  },
  {
    ...
    description:
      'Hybrid forecaster for multivariate sensor data on synthetic drilling logs.',
  ...
  },
  {
    ...
    description:
      'Feedforward neural network producing a 6-hour temperature forecast vs. a persistence baseline.',
